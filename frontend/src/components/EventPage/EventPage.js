          ...
          <div className={classes["event-page-content"]}>
            <div className={classes["event-info"]}>
              ...
              <div className={classes["event-info-description"]}>
                ...
                around the world, bringing together different cultures and
                styles. Experience the energy and excitement as performers take
                the stage and captivate the audience with their mesmerizing
                performances. Don't miss out on this incredible event filled
                with creativity, passion, and joy. Get your tickets now and be a
                part of this magical celebration!
              </div>
            </div>
